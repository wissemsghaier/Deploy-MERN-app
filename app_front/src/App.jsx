...
import ProtectedRoute from './components/ProtectedRoute';
import ErrorBoundary from './components/ErrorBoundary'; // Assurez-vous de l'importer correctement
        ...
        <ErrorBoundary>
          <Routes>
            ...
            <Route path='/admin' element={
              <ProtectedRoute isAuthenticated={isAuthenticated} role={isAdmin ? 'SUPERADMIN' : null}>
